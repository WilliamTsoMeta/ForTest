...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center justify-between min-h-screen p-24">
      ...
      <div className='w-[180px] h-12 bg-[#fbebf1] text-[#d01366] flex items-center justify-center text-xl border-2 border-white broder-r rounded-2xl cursor-pointer' onClick={()=>{router.push('/for-test')}}>
        Answer page
      </div>
